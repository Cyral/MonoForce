...
namespace MonoForce.Controls
{
    ...
    public class Control : Component
    {
        ...
        /// <summary>
        /// Indicates if text that has color (&c) are renderered
        /// </summary>
        ...
        public virtual void Remove(Control control, bool dispose = true)
        {
            // Valid control received?
            if (control != null)
            {
                ...
                //ATTENTION: Cyral's Addition, because of how he coded Zarknorth
                //This will DISPOSE the control after removing it
                control.Dispose();
                control = null;
            }
        }
